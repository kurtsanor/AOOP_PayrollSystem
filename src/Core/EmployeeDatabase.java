...
public class EmployeeDatabase {
    ...
    public List <Employee> getAllEmployees () {
        ...
        String query = "SELECT "
                ...
                + "FROM employees e JOIN roles r ON e.roleID = r.roleID ORDER BY employeeID DESC";
    ...
    public boolean addEmployee (Employee employee) {
        ...
        String query = "INSERT INTO employees (lastName, firstName, birthday, address, phoneNumber, sssNumber, philhealthNumber, tinNumber, pagibigNumber, status, position, roleID, supervisor, basicSalary, riceSubsidy, phoneAllowance, clothingAllowance, grossSemiMonthlyRate, hourlyRate) "
                     + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"; 
        try (PreparedStatement pst = connection.prepareStatement(query)) {                      
