...
public class EmployeeValidatorTest {
    ...
    public void testValidatePhoneNumber_Invalid() {
        assertEquals("This is required", EmployeeValidator.validatePhoneNumberWithMessage(""));
        assertEquals("Invalid format (e.g., 123-123-123)", EmployeeValidator.validatePhoneNumberWithMessage("123123123"));
        assertEquals("Cannot contain letters", EmployeeValidator.validatePhoneNumberWithMessage("123-12A-123"));
        assertEquals("Invalid format (e.g., 123-123-123)", EmployeeValidator.validatePhoneNumberWithMessage("123-1234-123"));
    }

    @Test
    public void testValidatePhoneNumber_Valid() {
        assertEquals("", EmployeeValidator.validatePhoneNumberWithMessage("123-123-123"));
    }
    ...
    public void testValidateSssNumber_Invalid() {
        assertEquals("This is required", EmployeeValidator.validateSssNumber(""));
        assertEquals("Invalid format (e.g., 12-1234567-1)", EmployeeValidator.validateSssNumber("1212345671"));
        assertEquals("Cannot contain letters", EmployeeValidator.validateSssNumber("12-123A567-1"));
    }

    @Test
    public void testValidateSssNumber_Valid() {
        assertEquals("", EmployeeValidator.validateSssNumber("12-1234567-1"));
    }

    @Test
    public void testValidatePhilhealth_Invalid() {
        assertEquals("This is required", EmployeeValidator.validatePhilhealthWithMessage(""));
        assertEquals("Must consist of only 12 digits", EmployeeValidator.validatePhilhealthWithMessage("12345678901"));
        assertEquals("Must contain digits only", EmployeeValidator.validatePhilhealthWithMessage("1234567890AB"));
    }

    @Test
    public void testValidatePhilhealth_Valid() {
        assertEquals("", EmployeeValidator.validatePhilhealthWithMessage("123456789012"));
    }

    @Test
    public void testValidatePagibig_Invalid() {
        assertEquals("This is required", EmployeeValidator.validatePagibigWithMessage(""));
        assertEquals("Must consist of only 12 digits", EmployeeValidator.validatePagibigWithMessage("1234567890"));
        assertEquals("Must contain digits only", EmployeeValidator.validatePagibigWithMessage("12345678ABCD"));
    }

    @Test
    public void testValidatePagibig_Valid() {
        assertEquals("", EmployeeValidator.validatePagibigWithMessage("123456789012"));
    }

    @Test
    public void testValidateTin_Invalid() {
        assertEquals("This is required", EmployeeValidator.validateTinWithMessage(""));
        assertEquals("Invalid format (e.g., 123-123-123-123)", EmployeeValidator.validateTinWithMessage("123123123123"));
        assertEquals("Cannot contain letters", EmployeeValidator.validateTinWithMessage("123-123-A23-123"));
    }

    @Test
    public void testValidateTin_Valid() {
        assertEquals("", EmployeeValidator.validateTinWithMessage("123-123-123-123"));
    }
}
