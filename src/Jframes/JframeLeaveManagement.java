...
public class JframeLeaveManagement extends javax.swing.JFrame {
    ...
    private void initTable () {
        ...
        jTable1.getColumnModel().getColumn(9).setCellRenderer(new TableActionCellRendererV2());
        jTable1.getColumnModel().getColumn(9).setCellEditor(new TableActionCellEditorV2(event));
    }
