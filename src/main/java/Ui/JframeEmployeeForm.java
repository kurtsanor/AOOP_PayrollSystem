...
public class JframeEmployeeForm extends javax.swing.JFrame {
    ...
    private Employee textFieldsInfoToEmployee () {
        ...
        jComboBoxPositions.getSelectedItem().toString().trim(),
        jComboBoxStatus.getSelectedItem().toString().trim(),
        LocalDate.parse(dateFormat.format(jDateChooserBirthday.getDate()).trim()),
        jTextFieldAddress.getText().trim(),
        jTextFieldPhoneNumber.getText().trim(),
        jTextFieldSssNumber.getText().trim(),
        jTextFieldPagibigNumber.getText().trim(),
        jTextFieldTinNumber.getText().trim(),
        Double.parseDouble(jTextFieldHourlyRate.getText().trim()),
        jTextFieldPhilhealthNumber.getText().trim(),
        jComboBoxRole.getSelectedItem().toString().trim(),
        Integer.parseInt(jComboBoxSupervisors.getSelectedItem().toString().trim()),
        Double.parseDouble(jTextFieldBasicSalary.getText().trim()),
        Double.parseDouble(jTextFieldRiceSubsidy.getText().trim()),        
        Double.parseDouble(jTextFieldPhoneAllowance.getText().trim()),
        Double.parseDouble(jTextFieldClothingAllowance.getText().trim()),
        Double.parseDouble(jTextFieldGrossSemiMonthly.getText().trim()        
        ));
    }
